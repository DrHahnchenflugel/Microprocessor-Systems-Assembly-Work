...
T_RIGHT       EQU   8
T_SPEED_ON    EQU   30
T_TURN_AROUND EQU   22
T_TURN_90     EQU   11
T_FWD_OVER_INTERSECTION EQU 20
...
LINE_VARIANCE           FCB   $19           ; Adding variance based on testing to 
...
T_SPD_CNTRL   RMB   1                       ; time to control drive speed
...
tab           dc.b  "waiting",0
              ...
              dc.b  "lft_tmd",0     
              dc.b  "rgt_tmd",0  
tab_heading   dc.b  "N",0
              dc.b  "E",0
              dc.b  "S",0
              dc.b  "W",0
tab_drivemode dc.b  "S",0
              dc.b  "B",0
...
VERIFY_FORWARD    CMPA  #FWD                                  ; Verify if the robot's state is FORWARD
                  BNE   VERIFY_REV_TRN                         ; If not, move to ALL_STOP state validation
...
;Movement
;***************************************************************************************************
START_ST          BRCLR   PORTAD0, $04, RELEASE                                    ;TODO - #$04?
                  JSR     INIT_FWD                                                               
                  MOVB    #FWD, CRNT_STATE
...
NO_FWD_BUMP       BRSET   PORTAD0, $08, NO_FWD_REAR_BUMP      ; Checks if the stern bumper - was 04, this is WRONG
...
NO_MISALIGNMENT   LDAA    SENSOR_PORT
                  ADDA    PORT_VARIANCE
                  CMPA    BASE_PORT
                  LBPL     NO_LEFT_INTERSECTION
                  ; port intersection there, turn to port.
                  LDAA    DRIVE_MODE
                  CMPA    #MODE_SEARCH
                  LBNE     PORT_INTERSECTION_SEARCH
PORT_INTERSECTION_BACK
                  ; dont inc n, update heading of robot and array
                  LBRA     DONE_HEADING_LEFT
...
PORT_INTERSECTION_SEARCH
                  ...
                  ABX
                  STAA    0,X
                  JSR     DONE_HEADING_RIGHT
                  
                  ;after the intersection, change drive mode to search
DONE_HEADING_LEFT LDAA    #MODE_SEARCH
                  STAA    DRIVE_MODE
                  JSR     INIT_90_TURN
...
NO_LEFT_INTERSECTION
                  ...
                  CMPA    BASE_STBD
                  LBPL     NO_INTERSECTION                  
                  ; intersection there - drive straight fwd.
                  LDAA    DRIVE_MODE
                  CMPA    #MODE_SEARCH
                  LBNE     STBD_INTERSECTION_SEARCH
...
STBD_INTERSECTION_SEARCH
                  ...
                  ;after the intersection, change drive mode to search
DONE_HEADING_RIGHT LDAA    #MODE_SEARCH
                   STAA    DRIVE_MODE
                  JSR     INIT_FWD_OVER_INTERSECTION
                  LBRA     GO_FWD_OVER_INTERSECTION  ;TODO  

NO_INTERSECTION                  
                  LDAA    SENSOR_LINE                                                             
                  ADDA    LINE_VARIANCE                                                                
                  CMPA    BASE_LINE                                                               
                  LBPL     CHECK_RIGHT_ALIGN                                                          
                  
                  LDAA    SENSOR_LINE                                                             
                  SUBA    LINE_VARIANCE                                                                
                  CMPA    BASE_LINE                                                              
                  LBMI     CHECK_LEFT_ALIGN
